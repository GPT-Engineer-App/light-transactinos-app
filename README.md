# light-transactinos-app

Make a n internal app to handle transactinos with all crud actions. 
...
```sh
git clone https://github.com/GPT-Engineer-App/light-transactinos-app.git
cd light-transactinos-app
npm i
```
